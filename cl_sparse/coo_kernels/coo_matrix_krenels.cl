...
__kernel void s_kernel_coo_permute(         const int  nnz,
...
// - adopted interface
// ----------------------------------------------------------
inline ValueType s_segreduce_warp(const int thread_lane, int row, ValueType val, __local int *rows, __local ValueType *vals) {
...
// - adopted interface
// ----------------------------------------------------------
inline void s_segreduce_block(__local const int *idx, __local ValueType *val) {
...
// - adopted interface
// ----------------------------------------------------------
__kernel void s_kernel_coo_spmv_reduce_update(         const       int  num_warps,
...
// - adopted interface
// ----------------------------------------------------------
__kernel void s_kernel_coo_spmv_serial(         const       int  num_entries,
                                     __global const       int *I,
                                     __global const       int *J,
                                     __global const ValueType *V,
                                              const ValueType  scalar,
...
__kernel void d_kernel_coo_permute(         const int  nnz,
                                 __global const int *in_row,
                                 __global const int *in_col,
                                 __global const int *perm,
                                 __global       int *out_row,
...
// - adopted interface
// ----------------------------------------------------------
inline ValueType d_segreduce_warp(const int thread_lane, int row, ValueType val, __local int *rows, __local ValueType *vals) {
...
// - adopted interface
// ----------------------------------------------------------
inline void d_segreduce_block(__local const int *idx, __local ValueType *val) {
...
// - adopted interface
// ----------------------------------------------------------
__kernel void d_kernel_coo_spmv_flat(         const       int  num_nonzeros,
                                            const       int  interval_size,
                                   __global const       int *I,
                                   __global const       int *J,
                                   __global const ValueType *V,
...
// - adopted interface
// ----------------------------------------------------------
__kernel void d_kernel_coo_spmv_reduce_update(         const       int  num_warps,
                                            __global const       int *temp_rows,
                                            __global const ValueType *temp_vals,
                                            __global       ValueType *y) {
...
// - adopted interface
// ----------------------------------------------------------
__kernel void d_kernel_coo_spmv_serial(         const       int  num_entries,
                                     __global const       int *I,
                                     __global const       int *J,
                                     __global const ValueType *V,
                                              const ValueType  scalar,
